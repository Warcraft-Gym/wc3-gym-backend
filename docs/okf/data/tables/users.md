...
- No user answer, list, single or nested, carries the [w3cstats](w3cstats.md) rows. The read loads them to derive `race_mmrs` and `main_race`, which the answer carries instead.
