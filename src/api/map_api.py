...
@swag_from({
    ...
    'security': [{'BearerAuth': []}],
    'parameters': [
        {'name': 'map_id', 'in': 'path', 'type': 'integer', 'required': True, 'description': 'The ID of the map to update'},
        {
            'name': 'body',
            'in': 'body',
            'required': True,
...
@swag_from({
    ...
    'tags': ['maps'],
    'security': [{'BearerAuth': []}],
    'parameters': [{'name': 'map_id', 'in': 'path', 'type': 'integer', 'required': True, 'description': 'The ID of the map to delete'}],
    'responses': {
...
@swag_from({
    ...
    'tags': ['maps'],
    'parameters': [{'name': 'map_id', 'in': 'path', 'type': 'integer', 'required': True, 'description': 'The ID of the map to retrieve'}],
    'responses': {
