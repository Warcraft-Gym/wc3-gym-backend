        ...
        return cls(
            {
                ...
                'team1': TeamDTO.from_dbteam_reduced(match.team1) if match.team1 else None,
                'team2_id': match.team2_id,
                'team2': TeamDTO.from_dbteam_reduced(match.team2) if match.team2 else None,
                'season_id': match.season_id,
                'season': SeasonDTO.from_dbseason_reduced(match.season) if match.season else None,
